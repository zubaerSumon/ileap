    ...
    <div className="max-w-[275px] space-y-6">
      ...
      <div className="pb-6 border-b">
        <div className="flex gap-3">
          <Button className="flex-1 bg-blue-700">Edit Profile</Button>
      ...
      <div className="pb-6 border-b">
        ...
        <div className="space-y-1">
          <p className="text-sm text-gray-600">Email - tiago@spotify.com</p>
      ...
      <div className="pb-6 border-b">
        ...
        <p className="text-sm text-gray-600">English (AUS)</p>
      </div>
