  ...
  return (
    <div className=" px-4 mb-8 ">
      ...
      <div className="mt-8 text-center md:text-left">
        ...
        <p className="text-gray-700">
          CEasy Care Gardening is a volunteer-based gardening service that helps
          senior Australians maintain their homes. Teams of volunteers weed,
          prune, mulch to make gardens safe and tidy, with the aim of keeping
          people in their own homes for longer. We love to see our volunteers
          make connections with the elderly community and feel like they are
          making a real contribution to their local community.
        </p>
      </div>
